...
constexpr const char* SETTINGS_BODY =
    ...
    "- Start Defense opens the mode picker: Normal Defense, Boss Rush, Daily Seed, Draft Defense, Endless Defense, or No-Flare Challenge.\n"
    "- All modes launch res://scenes/game.tscn and store the selected run mode on GameState metadata.\n"
    "- Best records for each mode save in user://settings.cfg.\n"
    ...
    "- Solar Flare uses F during active waves, except in No-Flare Challenge.\n"
    "- End screens support R for Retry and M for Main Menu.\n\n"
    "Mission Training\n"
    ...
    "4. Run the main menu, then Start Defense to choose a mode.\n\n"
    "Common Fixes\n"
