...
constexpr const char* SETTINGS_BODY =
    ...
    "- Start Defense opens the mode picker: Normal Defense, Endless Defense, or No-Flare Challenge.\n"
    "- All modes launch res://scenes/game.tscn and store the selected run mode on GameState metadata.\n"
    "- Best campaign, no-flare, and endless records save in user://settings.cfg.\n"
